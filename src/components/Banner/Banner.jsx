...
import bookImage from './../../../public/book-banner.png'

const Banner = () => {
    return (
        <div className='bg-slate-100 flex flex-col-reverse md:flex-row justify-between md:items-center px-3 md:px-28 py-4 md:py-20 md:rounded-3xl mb-24'>
